...
public class TexturedTriangleBuffer extends AbstractTriangleBuffer {
    ...
    private static final int DATA_ELEMENT_SIZE = POSITION_DATA_SIZE + TEX_COORD_DATA_SIZE;
	...
	public TexturedTriangleBuffer(final float[] verticesData, final int triangleType) {
		super(verticesData, DATA_ELEMENT_SIZE, triangleType);
	}
	
	public TexturedTriangleBuffer(final float[] verticesData, final short[] indicesData) {
		super(verticesData, DATA_ELEMENT_SIZE, indicesData, GLES20.GL_TRIANGLES);
	}
	
	public TexturedTriangleBuffer(final float[] verticesData, final short[] indicesData, final int triangleType) {
