...
public class ColoredTriangleBuffer extends AbstractTriangleBuffer {
    ...
    private static final int DATA_ELEMENT_SIZE = POSITION_DATA_SIZE + COLOR_DATA_SIZE;
    private static final int DATA_POSITION_OFFSET = 0;
    private static final int DATA_COLOR_OFFSET = POSITION_DATA_SIZE;
	...
	public ColoredTriangleBuffer(final float[] verticesData, final int triangleType) {
		super(verticesData, DATA_ELEMENT_SIZE, triangleType);
	}
	
	public ColoredTriangleBuffer(final float[] verticesData, final short[] indicesData) {
		super(verticesData, DATA_ELEMENT_SIZE, indicesData, GLES20.GL_TRIANGLES);
	}
	
	public ColoredTriangleBuffer(final float[] verticesData, final short[] indicesData, final int triangleType) {
	...
	public void render(final List<String> attributes) {
        ...
        super.setVertexAttrib(indices[1], attributes.get(1), DATA_STRIDE_BYTES, DATA_COLOR_OFFSET, COLOR_DATA_SIZE);
        super.draw();
